...
//+------------------------------------------------------------------+
#property copyright "Pin-pin_121 � 2012-2015 chew-z"
#include <TradeContext.mq4>
#include <TradeTools\TradeTools5.mqh>
#include <stdlib.mqh>

int magic_number_1 = 10303216;
string orderComment = "Pin-pin 1.21";
int contracts = 0;
...
// ENTER MARKET CONDITIONS
      ...
      // check for long position (BUY) possibility
         if(LongBuy == true )      {
            ...
            Risk = contracts*(Ask-StopLoss)*dbl2pips;
            if (IsTesting())
      ...
      // check for short position (SELL) possibility
         if(ShortBuy == true )      {
            ...
            Risk = contracts*(StopLoss-Bid)*dbl2pips;
            if (IsTesting())
                RiskPLN = Risk; // During testing MarketInfo( "PAIR", MODE_ASK) is always 0;
            else
                RiskPLN = Risk * pipsValuePLN(Symbol());
